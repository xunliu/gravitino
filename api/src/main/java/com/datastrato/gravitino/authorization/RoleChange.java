...
public interface RoleChange {
   ...
   */
  static RoleChange rename(String newName) {
    return new RenameRole(newName);
  }

  /** A RoleChange to rename a table. */
  final class RenameRole implements RoleChange {
    private final String newName;

    private RenameRole(String newName) {
