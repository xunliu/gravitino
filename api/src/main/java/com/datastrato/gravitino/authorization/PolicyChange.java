...
public interface PolicyChange {
  ...
  final class AddRowFilterPolicy implements PolicyChange {
    private final Function function;

    private AddRowFilterPolicy(Function function) {
    ...
    public boolean equals(Object o) {
      if (this == o) return true;
      if (o == null || getClass() != o.getClass()) return false;
      AddRowFilterPolicy that = (AddRowFilterPolicy) o;
    ...
    @Override
    public String toString() {
      return "ADDROWFILTERPOLICY " + function;
    }
  }
}
