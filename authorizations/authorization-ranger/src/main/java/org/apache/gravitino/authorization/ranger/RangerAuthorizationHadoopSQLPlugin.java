...
public class RangerAuthorizationHadoopSQLPlugin extends RangerAuthorizationPlugin {
  ...
  //   */
  //  @Override
  //  protected void doRenameSchemaMetadataObject(
  //          AuthorizationMetadataObject authzMetadataObject,
  ...
  //
  //      AuthorizationMetadataObject.Type type = (index == 0 ?
  // RangerHadoopSQLMetadataObject.Type.SCHEMA : (index == 1 ?
  // RangerHadoopSQLMetadataObject.Type.TABLE : RangerHadoopSQLMetadataObject.Type.COLUMN));
  ...
  //                      AuthorizationMetadataObject.getLastName(oldMetadataNames),
  //                      type);
  //      updatePolicyByMetadataObject(MetadataObject.Type.SCHEMA, authzMetadataObject1,
  // newAuthzMetadataObject1);
  //    }
  //  }
  //
  //  /**
  //   * Rename the TABLE, Need to rename these the relevant policies, `*.{table}`,
  // `*.{table}.{column}`
  //   * <br>
  //   */
  //  @Override
  //  protected void doRenameTableMetadataObject(
  //          AuthorizationMetadataObject authzMetadataObject,
  //          AuthorizationMetadataObject newAuthzMetadataObject) {
  //    List<String> oldMetadataNames = new ArrayList<>();
  //    List<String> newMetadataNames = new ArrayList<>();
  ...
  //            ImmutableList.of(
  //                    ImmutableMap.of(authzMetadataObject.names().get(0),
  // MetadataObject.Type.SCHEMA),
  //                    ImmutableMap.of(authzMetadataObject.names().get(1),
  ...
  //  @Override
  //  protected void doRenameColumnMetadataObject(
  ...
  //      }
  //      updatePolicyByMetadataObject(MetadataObject.Type.COLUMN, oldMetadataNames,
  // newMetadataNames);
  //    }
  //  }
  ...
  protected void doRenameMetadataObject(
    ...
    if (newAuthzMetadataObject.type().equals(SCHEMA)) {
      ...
      //      doRenameTableMetadataObject(authzMetadataObject, newAuthzMetadataObject);
      loop =
          ImmutableList.of(
              ImmutableMap.of(
                  authzMetadataObject.names().get(0), newAuthzMetadataObject.names().get(0)),
      ...
      //      doRenameColumnMetadataObject(authzMetadataObject, newAuthzMetadataObject);
  ...
  public List<AuthorizationMetadataObject> translateMetadataObject(MetadataObject metadataObject) {
    ...
    RangerHadoopSQLMetadataObject rangerHadoopSQLMetadataObject =
        new RangerHadoopSQLMetadataObject(
            ...
            type);
    rangerHadoopSQLMetadataObject.validate();
