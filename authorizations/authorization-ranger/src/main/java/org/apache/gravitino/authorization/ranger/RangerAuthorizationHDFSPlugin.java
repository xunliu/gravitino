...
public class RangerAuthorizationHDFSPlugin extends RangerAuthorizationPlugin {
  ...
  ////      updatePolicyByMetadataObject(MetadataObject.Type.SCHEMA, oldMetadataNames,
  // newMetadataNames);
  ////    }
  //  }
  //
  ...
  protected void doRenameMetadataObject(
    ...
    for (int index = 0; index < loop.size(); index++) {
      ...
      updatePolicyByMetadataObject(
          MetadataObject.Type.SCHEMA, authzMetadataObject1, newAuthzMetadataObject1);
    }
  }
  ...
  public List<AuthorizationSecurableObject> translatePrivilege(SecurableObject securableObject) {
    ...
    //    NameIdentifier identifier = NameIdentifier.of(securableObject.fullName());
                      ...
                      AuthorizationUtils.getMetadataObjectLocation(
                          ...
                          .forEach(
                              locationPath -> {
                                ...
                                pathBaseMetadataObject.validate();
