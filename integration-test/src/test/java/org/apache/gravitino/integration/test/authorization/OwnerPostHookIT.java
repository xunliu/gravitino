...
public class OwnerPostHookIT extends AbstractIT {
  ...
  public void testCreateFileset() {
    ...
    NameIdentifier fileIdent = NameIdentifier.of("schema1", "fileset1");
    catalog.asSchemas().createSchema("schema1", "comment", Collections.emptyMap());
    catalog
        .asFilesetCatalog()
    ...
    MetadataObject schemaObject =
        MetadataObjects.of(Lists.newArrayList(catalogNameA, "schema1"), MetadataObject.Type.SCHEMA);
    ...
    MetadataObject filesetObject =
        MetadataObjects.of(
            Lists.newArrayList(catalogNameA, "schema1", "fileset1"), MetadataObject.Type.FILESET);
  ...
  public void testCreateTopic() {
    ...
    catalogB
        .asTopicCatalog()
        .createTopic(
            NameIdentifier.of("default", "topic1"), "comment", null, Collections.emptyMap());
    ...
    MetadataObject topicObject =
        MetadataObjects.of(
            Lists.newArrayList(catalogNameB, "default", "topic1"), MetadataObject.Type.TOPIC);
  ...
  public void testCreateRole() {
    ...
    metalake.createRole("role1", Collections.emptyMap(), Lists.newArrayList(metalakeSecObject));
    ...
    MetadataObject roleObject = MetadataObjects.of(null, "role1", MetadataObject.Type.ROLE);
  ...
  public void testCreateTable() {
    ...
    NameIdentifier tableIdent = NameIdentifier.of("schema1", "table1");
    catalog.asSchemas().createSchema("schema1", "comment", Collections.emptyMap());
    catalog
        .asTableCatalog()
        .createTable(
    ...
    MetadataObject schemaObject =
        MetadataObjects.of(Lists.newArrayList(catalogNameD, "schema1"), MetadataObject.Type.SCHEMA);
    owner = metalake.getOwner(schemaObject).get();
    Assertions.assertEquals(AuthConstants.ANONYMOUS_USER, owner.name());
    Assertions.assertEquals(Owner.Type.USER, owner.type());
    ...
    MetadataObject tableObject =
        MetadataObjects.of(
            Lists.newArrayList(catalogNameD, "schema1", "table1"), MetadataObject.Type.TABLE);
