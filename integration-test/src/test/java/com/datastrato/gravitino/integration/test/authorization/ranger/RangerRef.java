...
public class RangerRef {
    ...
    public static final String SEARCH_FILTER_PATH =
            SearchFilter.RESOURCE_PREFIX + RESOURCE_PATH;
    ...
    public static final String ACCESS_TYPE_HDFS_READ = "read"; // Read access type
    public static final String ACCESS_TYPE_HDFS_WRITE = "write"; // Write access type
    public static final String ACCESS_TYPE_HDFS_EXECUTE = "execute"; // All access type
}
